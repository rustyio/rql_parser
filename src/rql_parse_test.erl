...
field1_test() ->
    Expect = [
        {where, 
            #function { field="field", function="=", args=["value"] }
        },
        {filter, undefined},
        {sort, undefined},
        {slice, undefined}
...
field2_test() ->
    Expect = [
        {where, 
            #function { field="field", function="=", args=["1"] }
        },
        {filter, undefined},
        {sort, undefined},
        {slice, undefined}
...
and1_test() ->
    Expect = [
        {where, 
            #intersection { ops=[
                #function { field="field1", function="=", args=["1"] },
                #function { field="field2", function="=", args=["2"] }
            ]}
        },
        {filter, undefined},
        {sort, undefined},
...
group1_test() ->
    Expect = [
        {where, 
            #intersection { ops=[
                ...
                #union { ops=[
                    #function { field="field2", function="=", args=["2"] },
                    #function { field="field3", function="=", args=["3"] }
                ]}
            ]}
        },
        {filter, undefined},
    ...
    test_helper("field1 = 1 AND (field2 = 2 OR field3 = 3)", Expect).
...
group2_test() ->
    Expect = [
        {where, 
            #intersection { ops=[
                #union { ops=[
                    #function { field="field1a", function="=", args=["1a"] },
                    #function { field="field1b", function="=", args=["1b"] }
                ]},
                #union { ops=[
                    #function { field="field2", function="=", args=["2"] },
                    #intersection { ops=[
                        #function { field="field3", function="=", args=["3"] },
                        #function { field="field4", function="=", args=["4"] }
                    ]}
                ]}
            ]}
        },
    ...
    test_helper("(field1a='1a' OR field1b='1b') AND (field2=2 OR (field3=3 AND field4=4))", Expect).
...
filter2_test() ->
    ...
    test_helper("
        WHERE field1=1
        FILTER field2=2 OR field3=3
        ", Expect).

in1_test() ->
    Expect = [
        {where, 
            #function { field="field", function="in", args=["1", "2", "3"] }
        },
        {filter, undefined},
        {sort, undefined},
        {slice, undefined}
...
function1_test() ->
    Expect = [
        {where, 
            #function { field="field", function="equals", args=["1"] }
        },
        {filter, undefined},
        {sort, undefined},
        {slice, undefined}
...
function2_test() ->
    Expect = [
        {where, 
            #union { ops=[
                #function { field="field1", function="equals", args=["1"] },
                #function { field="field2", function="near", args=["one", "two"] }
            ]}
        },
        {filter, undefined},
        {sort, undefined},
    ...
    test_helper("field1.equals(1) OR field2.near('one', 'two')", Expect).

function3_test() ->
    Expect = [
        {where, 
            #union { ops=[
                #function { field="a.b.c.field1", function="equals", args=["1"] },
                #function { field="a.b.c.field2", function="near", args=["one", "two"] }
            ]}
        },
        {filter, undefined},
        {sort, undefined},
    ...
    test_helper("a.b.c.field1.equals(1) OR a.b.c.field2.near('one', 'two')", Expect).
...
test_helper(String, Expect) ->
    {ok, Tokens, _} = rql_scan:string(String),
    {ok, Actual} = rql_parse:parse(Tokens),
